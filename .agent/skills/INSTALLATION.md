...
This guide explains how to install dependencies for Gemini/Antigravity skills.
...
```powershell
cd $env:USERPROFILE\.gemini\skills
...
# Python packages (ai-multimodal only)
cd $env:USERPROFILE\.gemini\skills\ai-multimodal\scripts
pip install -r requirements.txt
