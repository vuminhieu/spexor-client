...
```bash
node .agent/scripts/set-active-plan.cjs {plan-folder}
```
Example: `plans/260108-1418-custom-domain-refactor/phase-01-database.md` → run `node .agent/scripts/set-active-plan.cjs plans/260108-1418-custom-domain-refactor`
...
- Step 5: `✓ Step 5: Finalize - Status updated`
