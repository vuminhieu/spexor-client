...
```bash
python .agent/scripts/ck-help.py "$ARGUMENTS"
```
...
- Use global (~/.agent/.ck.json) for personal preferences like language, issue prefix style
- Use local (./.agent/.ck.json) for project-specific paths, naming conventions
