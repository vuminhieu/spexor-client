...
**IMPORTANT**: Activate relevant skills from `~/.gemini/skills/*` or `./.agent/skills/*` during execution.
**IMPORTANT**: Follow rules in `~/.gemini/.agent/workflows/workflows/development-rules.md` and `./docs/code-standards.md`.
