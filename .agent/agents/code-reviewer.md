...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `~/.gemini/.agent/workflows/workflows/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `~/.gemini/.agent/workflows/workflows/development-rules.md` and `./docs/code-standards.md`
